...
namespace BlowFishCS
{
    ...
    //Triple ECB Mode
    //Triple CBC Mode
    //Почитать: https://www.openssl.org/docs/manmaster/man7/des_modes.html
    ...
    class BlowFish
    {
        ...
        //Полублоки (разделение напополам)
        private uint xl_par;
        private uint xr_par;
        ...
        //Совместимость с javascript CRYPTOLIBRARY
        private bool nonStandardMethod;

        /// <summary>
        /// Конструктор для шестнадцатеричного ключа
        /// </summary>
        /// <param name="hexKey">Ключ шифрования как шестнадцатеричная строка</param>
        ...
        /// </summary>
        /// <param name="cipherKey">Ключ шифрования массив байтов</param>
        ...
        /// <summary>
        /// Шифрование строки в режиме CBC
        /// </summary>
        /// <param name="pt">Строка для шифрования</param>
        /// <returns>Зашифрованный текст с добавлением вектора инициализации спереди</returns>
        ...
        /// <summary>
        /// Расшифровывает строку в режиме CBC
        /// </summary>
        /// <param name="ct">Зашифрованный текст с добавлением вектора инициализации спереди</param>
        ...
        /// <summary>
        /// Расшифровывает байтовый массив в режиме CBC.
        /// Вектор инициализации необходимо создать и сохранить вручную.
        /// </summary>
        /// <param name="ct">Данные для дешифрования</param>
        /// <returns>Текст</returns>
        ...
        /// <summary>
        /// Зашифровывает байтовый массив в режиме CBC.
        /// IV необходимо создать и сохранить вручную.
        /// </summary>
        /// <param name="pt">Данные для шифрования</param>
        ...
        /// </summary>
        /// <param name="pt">Текст для шифрования как строка ascii</param>
        /// <returns>Шестнадцатеричное представление зашифрованных данных</returns>
        ...
        /// <summary>
        /// Расшифровывает строку (ECB)
        /// </summary>
        /// <param name="ct">Шестнадцатеричная строка зашифрованного текста</param>
        /// <returns>Текстовая ascii строка</returns>
        ...
        /// <summary>
        /// Шифрует байтовый массив в режиме ECB
        /// </summary>
        /// <param name="pt">Текст</param>
        /// <returns>Массив байтов шифротекста</returns>
        ...
        /// <summary>
        /// Расшифровывает байтовый массив (ECB)
        /// </summary>
        /// <param name="ct">Массив байтов шифротекста</param>
        /// <returns>Текст</returns>
        ...
        /// <summary>
        /// Инициализация вектора инициализации  для режима CBC.
        /// </summary>
        public byte[] IV
        {
            ...
            set
            {
                ...
                {
                    throw new Exception("Недопустимый размер вектора инициализации.");
                }
            }
        }
        ...
        /// <summary>
        /// Создает и устанавливает случайный вектор инициализации.
        /// </summary>
        /// <returns>Рандомный вектор инициализации </returns>
        ...
        /// <summary>
        /// Устанавливает S-блоки и ключ
        /// </summary>
        /// <param name="cipherKey">Блочный ключ шифрования (1-448 бит)</param>
        private void SetupKey(byte[] cipherKey)
        {
            ...
            key = new byte[cipherKey.Length]; // 448 бит
            if (cipherKey.Length > 56)
            {
                throw new Exception("Ключ слишком длинный. Требуется 56 байтов.");
            }
        ...
        /// <summary>
        /// Шифрует и расшифровывает данные в режиме ECB
        /// </summary>
        /// <param name="text">текст/шифротекст</param>
        /// <param name="decrypt">true для расшифровки, false для шифрования</param>
        /// <returns>(En/De) данные для шифрования</returns>
        ...
        /// <summary>
        /// Шифрует и расшифровывает данные в режиме CBC
        /// </summary>
        /// <param name="text">текст/шифротекст</param>
        /// <param name="decrypt">true для расшифровки, false для шифрования</param>
        /// <returns>(En/De) данные для шифрования</returns>
        private byte[] Crypt_CBC(byte[] text, bool decrypt)
        {
            if (!IVSet)
            {
                throw new Exception("Не задан вектор инициализации.");
            }
            int paddedLen = (text.Length % 8 == 0 ? text.Length : text.Length + 8 - (text.Length % 8));
            byte[] plainText = new byte[paddedLen];
            Buffer.BlockCopy(text, 0, plainText, 0, text.Length);
        ...
        /// </summary>
        /// <param name="block">8-разрядный блок 1</param>
        /// <param name="iv">8-битный блок 2</param>
        ...
        /// </summary>
        /// <param name="block">64-битный блок для шифрования</param>
        ...
        /// </summary>
        /// <param name="block">64-разрядный блок для дешифрования</param>
        ...
        /// <summary>
        /// Разделение блока на два значения uint
        /// </summary>
        /// <param name="block">установка 64-битного блока</param>
        ...
        /// <summary>
        /// Преобразует два значения uint в 64-битный блок
        /// </summary>
        /// <param name="block">64-битный буфер для приема блока</param>
        private void GetBlock(ref byte[] block)
        {
            ...
            //Присоединение к блоку
            Buffer.BlockCopy(block1, 0, block, 0, 4);
            Buffer.BlockCopy(block2, 0, block, 4, 4);
        }

        /// <summary>
        /// Выполняет алгоритм blowfish (стандартные 16 раундов)
        /// </summary>
        ...
        /// <summary>
        /// Выполняет алгоритм blowfish в обратном порядке (стандартные 16 раундов)
        /// </summary>
        ...
        #region SBLOCKS
        //Уникальная последовательность мантиссы числа PI. 
        //Значением мантиссы числа PI заполняется матрица раундовых ключей (SetupP)
        //Количество шестнадцатеричных цифр может быть увеличено, если вы хотите поэкспериментировать с большим количеством раундов и длинными ключами
        private uint[] SetupP()
        {
            return new uint[] {
        ...
        //Значением мантиссы числа PI заполняется матрица раундовых ключей (SetupP) и матрицы подстановки (SetupS)
